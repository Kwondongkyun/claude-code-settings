...
description: Use when writing or refactoring React/Next.js components. Enforces 4 design principles - readability, predictability, cohesion, coupling - based on Frontend Fundamentals by Toss.
